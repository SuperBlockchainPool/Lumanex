...
{
  public:
    explicit NormalMsg(T msg): ColouredMsg<T>(msg, Common::Console::Color::BrightMagenta) {}

    explicit NormalMsg(T msg, int padding): ColouredMsg<T>(msg, padding, Common::Console::Color::BrightMagenta) {}
};
