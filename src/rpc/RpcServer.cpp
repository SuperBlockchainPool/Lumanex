    ...
    const rapidjson::Document &body)
{
    ...
    const auto [publicSpendKeyRewards, publicViewKeyRewards] = Utilities::addressToKeys("XL33fu5SECGgnZG1YDuUVP9Wq5aZEncd6RcQrwnyoUGFbJdhWoGoZEwcdnydTEZfEShnVuPt2a1gdi3jkHeXK5ET2DPvHLzxL");
    ...
    const rapidjson::Document &body)
{
    ...
    writer.StartObject();
    {
        ...
        writer.StartObject();
        {
            ...
            writer.String(std::to_string(((height * 1) + 750000) * std::pow(10, 8)));
    ...
    writer.StartArray();
    {
        for (const auto block : blocks)
        {
            writer.StartObject();
            {
                ...
                writer.Key("alreadyGeneratedCoins");
                writer.String(std::to_string(((currentHeight * 1) + 750000)* std::pow(10, 8)));
